...
class QMC5883L(object):
    ...
    _REG_QMC5883L_TEMP_OUT_H = 0X07
    _REG_QMC5883L_TEMP_OUT_L = 0X08
    ...
    _REG_DATA_UPDATE_RATE_ODR_50HZ = 0x08
    _REG_DATA_UPDATE_RATE_ODR_100HZ = 0x10
    _REG_DATA_UPDATE_RATE_ODR_200HZ = 0x18
    _REG_OVERSAMPLING_OSR_64 = 0x180
    _REG_OVERSAMPLING_OSR_128 = 0x100
    _REG_OVERSAMPLING_OSR_256 = 0x80
    _REG_OVERSAMPLING_OSR_512 = 0x00
    _REG_FULL_SCALE_RNG_2G = 0x00
    _REG_FULL_SCALE_RNG_8G = 0x20
    ...
    def __convert_data_register_shift(self, address_devise=0, high_bit=0, low_bit=0):
        high_bit_ = self.i2c_bus.read_byte_data(address_devise, high_bit)
        low_bit_ = self.i2c_bus.read_byte_data(address_devise, low_bit)
    ...
    def get_temp(self) -> float:
        ...
        :return: temp
        """
        temp_data_signed_int_ = self.__convert_data_register_shift(self.device_address,
                                                                   self._REG_QMC5883L_TEMP_OUT_H,
                                                                   self._REG_QMC5883L_TEMP_OUT_L)
        temp = ((temp_data_signed_int_) / 100) + 36.53
        return temp
